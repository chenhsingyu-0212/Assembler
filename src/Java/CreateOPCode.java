...
public class CreateOPCode {
    ...
    public CreateOPCode(ArrayList<String[]> datas, ArrayList<String> loc, ArrayList<Integer> format, Map<String, String> symtab){
    ...
    public String getDisp(int i, String symbol, ArrayList<String> loc, Boolean x, EXTREF extref, Map<String, String> symtab){
        int disp = 0;
        int xbpi = 0;
    ...
    public String getAddress(int i, String symbol, ArrayList<String> loc, Boolean x, Boolean e, EXTREF extref, Map<String, String> symtab){
        int disp = 0;
        int xbpi = 0;
